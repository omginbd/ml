...
class Matrix {
    ...
    constructor(that, rowStart, colStart, rowCount, colCount, relationName) {
        this.m_data = [];
        this.m_attr_name = [];
        this.m_str_to_enum = [];
        this.m_enum_to_str = [];
                ...
                if (!READDATA) {
                    ...
                    switch (firstToken) {
                        ...
                        case '@DATA':
                            ...
                            break;
                        default:
                            throw new Error("Error processing file. Expected @RELATION, @ATTRIBUTE, or @DATA. Instead got '" +
                                line +
                                "'.");
                    }
                }
